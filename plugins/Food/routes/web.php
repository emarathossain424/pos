...
Route::prefix('/food')->middleware('auth')->group(function () {
    ...
    Route::post('/single-item-variants', [FoodItemController::class, 'getVariants'])->name('single.item.variants');
    ...
    Route::post('/get-single-item-properties', [PropertyController::class, 'getSingleItemProperties'])->name('get.single.item.properties');
});
